...
The main computation bottleneck in SAC arises from the number of backprop updates. This is tackled by exponentially annealing these updates and increasing winner-based evolutions and crossovers for transferring skills between SAC agent and ES offspings. Figure below presents a comparison between the number of backprop updates carried out using SAC and ESAC during the training phase of MuJoCo tasks. ESAC executes lesser number of updates highlighting its computationally efficient nature and low dependency on a gradient-based scheme for monotonic improvement.  

<p align="center"><img src="/images/all_update.png" height="250" width="800" /></p>
